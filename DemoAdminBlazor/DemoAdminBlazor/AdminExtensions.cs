...
/// <summary>
/// 管理 DemoAdminBlazor 相关配置的选项类
/// </summary>
public class DemoAdminBlazorOptions
{
    /// <summary>
    /// 工作节点 ID，默认值为 1
    /// </summary>
...
/// <summary>
/// 包含 DemoAdminBlazor 服务扩展方法的静态类
/// </summary>
public static class AdminExtensions
{
    /// <summary>
    /// 向服务集合中添加 DemoAdminBlazor 相关服务
    /// </summary>
    /// <param name="builder">服务集合</param>
    /// <param name="options">DemoAdminBlazor 配置选项</param>
    /// <returns>添加服务后的服务集合</returns>
    public static WebApplicationBuilder AddDemoAdminBlazor(this WebApplicationBuilder builder, DemoAdminBlazorOptions options)
    {
        var configuration = builder.Configuration;

        // 若选项为空，则使用默认选项
        if (options == null) options = new DemoAdminBlazorOptions();
        ...
        builder.Services.Configure<DemoAdminBlazorOptions>(adminOptions =>
        {
